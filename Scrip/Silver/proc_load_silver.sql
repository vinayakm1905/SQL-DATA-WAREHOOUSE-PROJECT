...
SELECT [prd_id]
     -- ,[prd_key]
	   ,replace(SUBSTRING(prd_key,1,5),'-','_') as cat_id---THIS is derieved column
	   ,substring(prd_key,7,len(prd_key)) as prd_key ---THIS is derieved column
      ,[prd_nm]
